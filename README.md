...
### 🚀 高效追踪 (Efficiency)
- **右键一键追踪**：在网页上的任何链接上点击右键，选择“添加链接到 MagnetTracker”即可快速入库，无需停下当前浏览工作。支持捕获选中的超链接，完美适配资源搜索结果页。
- **追更状态识别**：自动对比并记录已复制的磁力链接。预览区**仅显示未处理的新内容**，彻底告别重复筛选。
- **一键批量操作**：支持单条复制、卡片全量提取，以及全局“复制所有最新”功能，秒级完成资源收集。
- **智能过滤引擎**：内置 1080p、2160p (4K)、720p 过滤逻辑，多维度的精准匹配。
